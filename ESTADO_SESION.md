...
### 🎯 Botón "Regresar a Pedidos" en Gestión de Vendedores
**Solución**: Agregado botón verde sin fondo para regresar a Pedidos desde la página de vendedores.

**Archivo modificado**:
- `frontend/src/pages/VendedoresScreen.jsx`

### 🎯 Eliminar rutas con doble clic y modal de confirmación
**Problema**: No había forma de eliminar rutas.

**Solución**:
- Primer clic: Selecciona la ruta
- Segundo clic: Aparece ícono de eliminar (azul con basura blanca)
- Clic en ícono: Abre modal elegante con advertencia
- Modal con botones "Cancelar" y "Eliminar Ruta"

**Archivo modificado**:
- `frontend/src/components/rutas/GestionRutas.jsx`

### 🎯 Notas de cliente eliminadas de Pedidos
**Solución**: Eliminada la sección "Preferencias / Notas del Cliente" del formulario de Pedidos ya que la nota se muestra en el carrito.

**Archivo modificado**:
- `frontend/src/components/Pedidos/ConsumerForm.jsx`

### 🎯 Listas de precios hardcodeadas para carga rápida
**Solución**: El select muestra inmediatamente VENDEDORES, DOMICILIOS y PRECIOS CAJA mientras se cargan las listas reales desde la API.
...
### Prioridad Alta:
1. **Mejorar interfaz de Pedidos en 1920x1080**
   - Aumentar tamaño de imagen del producto
   - Disminuir tamaño de descripción y precio
   
2. **Tickets de impresión**
   - POS: Tinta suave, texto pequeño
   - App Móvil: Mejoras pendientes
...
**Última actualización**: 27 Enero 2026 - Eliminar rutas, mejoras UI, listas precargadas  
**Estado del sistema**: ✅ Operativo  
**Cambios desplegados en VPS**: 🔧 Pendiente (subir manualmente)  
**Próxima sesión**: Mejorar Pedidos 1920x1080, tickets de impresión
