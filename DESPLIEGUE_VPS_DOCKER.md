...
3.  **Aplicar Cambios (Rebuild + Migraciones):**
    ...
    **⚠️ HOY:** Cambios en Frontend (POS) + Migraciones pendientes en Backend.
    
    **Paso 1: Reconstruir contenedores**
    ```bash
    docker compose -f docker-compose.prod.yml up -d --build
    ```
    *(Espera 2-3 minutos mientras reconstruye).*
    ...
    *Deberías ver:*
    ```
    Applying api.0081_productosfrecuentes... OK
    Applying api.0082_productosfrecuentes_nota... OK
    Applying api.0083_listaprecio_visible_pos... OK
    Applying api.0084_venta_creado_por... OK
    Applying api.0085_add_turno_to_movimientocaja... OK
    ```
