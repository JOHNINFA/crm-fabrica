...
from .views import (
    ...
    calcular_devoluciones_automaticas, control_stock_tiempo_real, ventas_tiempo_real, cerrar_turno_vendedor,
...
urlpatterns = router.urls + [
    ...
    path('cargue/control-stock/<str:id_vendedor>/<str:fecha>/',
         control_stock_tiempo_real,
         name='control-stock-tiempo-real'),
